...
{
    TRAIN_AND_SAVE(har, HAR_X, HAR_Y)
}
...
void batch_train_and_save(const cxxopts::ParseResult& options)
{
    ...
    auto attackers = parse_batch_file<HAR_X>(args.batch_file, args.attack_file, args.budget, args.epsilon);
